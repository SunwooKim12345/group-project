    ...
    return (
        ...
        {isClicked && <div className='d-flex container-fluid justify-content-end'>
            <ul className="nav nav-sm flex-column">
                ...
                <li className="nav-item">
                    <Link className="nav-select nav-link active d-flex justify-content-center" to="/previous-courses" onClick={add_active}>PreviousCourses</Link>
                </li>
                <li className="nav-item">
